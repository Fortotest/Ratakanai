...
export function StrategyLab() {
    ...
    return (
        <section id="strategy-lab">
            <CardGlass className="p-8 space-y-12">
                <div>
                    <CardHeader className="p-0 text-center">
                        <CardTitle className="text-3xl md:text-4xl font-bold">Laboratorium Strategi</CardTitle>
                        <CardDescription className="mt-2 text-lg text-foreground/80">Uji asumsi bisnismu di sini. Setiap angka akan terintegrasi ke seluruh dasbor secara real-time.</CardDescription>
                    </CardHeader>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6 p-0">
